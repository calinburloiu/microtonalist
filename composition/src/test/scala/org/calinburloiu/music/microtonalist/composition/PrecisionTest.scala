...
class PrecisionTest extends AnyWordSpec with Matchers with TableDrivenPropertyChecks {

  "AutoTuningMapper" should {
    "not alter the quarter tones mapping when the interval class changes, if quarterToneTolerance is used" in {
  ...
  "roundWithTolerance" should {
    "round to the nearest integer, rounding halves down or up, within the tolerance" in {
      //@formatter:off
