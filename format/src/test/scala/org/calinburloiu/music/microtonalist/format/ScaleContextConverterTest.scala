...
class ScaleContextConverterTest extends AnyWordSpec, Matchers, BeforeAndAfter {
  ...
  "ScaleContextConverter" should {
    "override the scale name with the one from the context" in {
      // Given
    ...
    "convert a cents scale to 72-EDO intonation standard provided in the context" in {
      // Given
    ...
    "fail to convert a cents scale to just intonation standard provided in the" in {
      // Given
    ...
    "convert a just scale to cents intonation standard provided in the context" in {
      // Given
    ...
    "convert a just scale to 72-EDO intonation standard provided in the context" in {
      // Given
      val context = Some(ScaleFormatContext(intonationStandard = Some(EdoIntonationStandard(72))))
      // When
      val result = scaleContextConverter.convert(maj4RatiosScale, context)
    ...
    "convert a 53-EDO scale to cents intonation standard provided in the context" in {
      // Given
      val context = Some(ScaleFormatContext(intonationStandard = Some(CentsIntonationStandard)))
      // When
    ...
    "convert a 53-EDO scale to 72-EDO intonation standard provided in the context" in {
      // Given
      val context = Some(ScaleFormatContext(intonationStandard = Some(EdoIntonationStandard(72))))
      // When
      val result = scaleContextConverter.convert(hicaz4Edo53Scale, context)
    ...
    "not do any conversion and return the same scale if no context is provided" in {
      // When
