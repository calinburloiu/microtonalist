...
class JsonIntervalFormatTest extends JsonFormatTestUtils {
  ...
  "formatFor" should {
    "read cents and ratio intervals in CentsIntonationStandard" in {
    ...
    "read ratio intervals in JustIntonationStandard" in {
    ...
    "not read invalid data in JustIntonationStandard" in {
      val format: Format[Interval] = JsonIntervalFormat.formatFor(JustIntonationStandard)
    ...
    "read EDO and ratio intervals in EdoIntonationStandard" in {
    ...
    "not read invalid data in EdoIntonationStandard" in {
      val format: Format[Interval] = JsonIntervalFormat.formatFor(EdoIntonationStandard(72))
    ...
    "write a ratio interval" in {
      val format = JsonIntervalFormat.formatFor(CentsIntonationStandard)
      format.writes(5 /: 4) shouldEqual JsString("5/4")
    }

    "write EDO intervals" in {
      val format = JsonIntervalFormat.formatFor(CentsIntonationStandard)
