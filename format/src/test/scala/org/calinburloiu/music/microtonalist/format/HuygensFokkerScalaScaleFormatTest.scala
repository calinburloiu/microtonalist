...
class HuygensFokkerScalaScaleFormatTest extends AnyWordSpec with Matchers {
  private val scaleFormat: ScaleFormat = new HuygensFokkerScalaScaleFormat

  "Reading a .scl file with invalid header" should {
  ...
  "Reading a .scl file with invalid pitch count" should {
    "throw InvalidScalaTuningFileException" in testFailure(
      """description
        |three
        |100.0
  ...
  "Reading a .scl file with a non-number pitch" should {
    "throw InvalidScalaTuningFileException" in testFailure(
  ...
  "Reading a .scl file with a negative cents value" should {
    "throw InvalidScalaTuningFileException" in testFailure(
      """Scale with pitches in cents
        |3
        |100.2
  ...
  "Reading a .scl file with a negative ratio value" should {
    "throw InvalidScalaTuningFileException" in testFailure(
      """Scale with pitches in cents
        |3
        |100.2
  ...
  "Reading a .scl file with a high numerator for the ratio value" should {
    "throw InvalidScalaTuningFileException" in
      testFailure(
        """Scale with pitches in cents
          |3
          |100.2
  ...
  "Reading a .scl file with a high denominator for the ratio value" should {
    "throw InvalidScalaTuningFileException" in
      testFailure(
        """Scale with pitches in cents
          |3
  ...
  "Reading a .scl file with pitches in cents" should {
    "correctly create a CentsScale object" in testSuccess(
      """Scale with pitches in cents
        |3
        |100.2
        |201.451
  ...
  "Reading a .scl file with pitches as ratios" should {
    "correctly create a RatiosScale object" in testSuccess(
  ...
  "While reading a .scl file, comment lines" should {
    "be ignored" in testSuccess(
      """! scale.scl
        |!
        |Scale with pitches as both ratios and cents!
        |!4 pitches
  ...
  "While reading a .scl file, anything after a valid pitch value should be ignored" should {
    "be ignored" in testSuccess(
      """Scale with pitches as both ratios and cents!
        |4
        |100.2cents
  ...
  "While reading a .scl file, any white space around a pitch" should {
    "be ignored" in testSuccess(
      """Scale with pitches as both ratios and cents!
        |4
        | 100.2
  ...
  "Reading a .scl file with zero pitches" should {
    "be acceptable, it implies the base note" +
      "(1/1, 0 cents)" in
      testSuccess(
  ...
  def testFailure(scalaTuningFileString: String, maybeMessageContained: Option[String] = None): Unit = {
    ...
    val caught = intercept[InvalidHuygensFokkerScalaFileException] {
      scaleFormat.read(input, None, None)
    }
  ...
  def testSuccess(scalaTuningFileString: String, expectedScale: Scale[Interval]): Unit = {
    ...
    val actualScale = scaleFormat.read(input, None, None)
