 ...
 */
sealed abstract class TrackEvent extends BusinessyncEvent
 ...
 */
case class TracksClosedEvent(uri: Option[URI]) extends TrackEvent
 ...
 */
case class TracksReplacedEvent(tracks: TrackSpecs) extends TrackEvent
 ...
 */
case class TrackUpdatedEvent(track: TrackSpec) extends TrackEvent
 ...
 */
case class TrackRemovedEvent(id: TrackSpec.Id) extends TrackEvent
