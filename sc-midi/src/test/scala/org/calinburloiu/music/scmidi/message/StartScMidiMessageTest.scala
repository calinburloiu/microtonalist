...
class StartScMidiMessageTest extends AnyFlatSpec with Matchers {
  private val javaMessage: MidiMessage = new ShortMessage(ShortMessage.START)

  behavior of "StartScMidiMessage"

  it should "create correct Java MIDI message" in {
    // When / Then
    StartScMidiMessage.toJavaMidiMessage.getStatus should equal(ShortMessage.START)
    StartScMidiMessage.toJavaMidiMessage.getMessage should equal(javaMessage.getMessage)
  }
