...
class MidiSplitterTest extends AnyWordSpec, Matchers, Stubs {
  ...
  "constructor" should {
    "expose the transmitter it was given" in new Fixture {
      // Given
  ...
  "send" should {
    "forward every message, with its time-stamp, to every receiver of an immutable transmitter" in
      new Fixture {
        // Given
    ...
    "forward to receivers added to a mutable transmitter after construction" in new Fixture {
      // Given
    ...
    "forward to receivers added to a concurrent transmitter after construction" in new Fixture {
      // Given
    ...
    "do nothing when the transmitter has no receivers" in new Fixture {
      // Given
