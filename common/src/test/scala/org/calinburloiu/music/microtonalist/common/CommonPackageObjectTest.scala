...
class CommonPackageObjectTest extends AnyWordSpec with Matchers {

  "parseUrlOrPath" should {
    "parse an absolute URL" in {
      parseUrlOrPath("https://example.org/path/to/file.json") should contain(
